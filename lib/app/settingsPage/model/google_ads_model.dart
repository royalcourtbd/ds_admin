...
GoogleAdsModel googleAdsModelFromJson(String str) =>
    GoogleAdsModel.fromJson(json.decode(str));

String googleAdsModelToJson(GoogleAdsModel data) => json.encode(data.toJson());
